...
function register(languageService, getTextDocument, settings, ts) {
    return (uri, position, options) => __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        ...
        try {
            completionContext = languageService.getCompletionsAtPosition(fileName, offset, Object.assign(Object.assign({}, preferences), options));
        }
        catch (_c) { }
        ...
        function getDotAccessorContext(tsVersion, document) {
        ...
        function isInValidCommitCharacterContext(document, position, tsVersion) {
