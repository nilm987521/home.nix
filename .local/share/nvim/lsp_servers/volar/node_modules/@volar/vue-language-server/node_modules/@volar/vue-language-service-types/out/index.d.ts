...
declare type NotNullableResult<T> = T | Thenable<T>;
declare type NullableResult<T> = NotNullableResult<T | undefined | null>;
export declare function useConfigurationHost(): ConfigurationHost | undefined;
export declare function setCurrentConfigurationHost(configHost: ConfigurationHost | undefined): void;
