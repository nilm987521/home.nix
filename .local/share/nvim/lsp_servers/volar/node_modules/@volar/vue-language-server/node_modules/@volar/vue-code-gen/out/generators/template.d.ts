...
export declare function generate(ts: typeof import('typescript/lib/tsserverlibrary'), sourceLang: string, templateAst: CompilerDOM.RootNode, vueVersion: number, experimentalRuntimeMode: 'runtime-dom' | 'runtime-uni-app' | undefined, allowTypeNarrowingInEventExpressions: boolean, cssScopedClasses: string[] | undefined, htmlToTemplate: (htmlStart: number, htmlEnd: number) => {
    start: number;
    end: number;
