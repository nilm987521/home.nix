...
function register(context) {
    return (document, options, range, onTypeParams) => __awaiter(this, void 0, void 0, function* () {
        ...
        const rootEdits = onTypeParams
            ? yield tryFormatOnType(document, onTypeParams.position, onTypeParams.ch)
            : yield tryFormat(document, range);
        ...
        while (true) {
            ...
            for (const embedded of embeddeds) {
                ...
                let _edits;
                if (onTypeParams) {
                    const embeddedPosition = (_b = sourceMap.getMappedRange(onTypeParams.position)) === null || _b === void 0 ? void 0 : _b[0].start;
                    if (embeddedPosition) {
                        _edits = yield tryFormatOnType(sourceMap.mappedDocument, embeddedPosition, onTypeParams.ch);
                    }
                }
                else {
                    let embeddedRange = (_c = sourceMap.getMappedRange(range.start, range.end)) === null || _c === void 0 ? void 0 : _c[0];
                    if (!embeddedRange) {
                        let start = (_d = sourceMap.getMappedRange(range.start)) === null || _d === void 0 ? void 0 : _d[0].start;
                        let end = (_e = sourceMap.getMappedRange(range.end)) === null || _e === void 0 ? void 0 : _e[0].end;
                        if (!start) {
                    ...
                    if (embeddedRange) {
                        ...
                        _edits = yield tryFormat(sourceMap.mappedDocument, embeddedRange);
                    }
                }
                if (!_edits)
                    continue;
        ...
        function tryFormat(document, range) {
        ...
        function tryFormatOnType(document, position, ch) {
            return __awaiter(this, void 0, void 0, function* () {
                const plugins = context.getFormatPlugins();
                context.updateTsLs(document);
                for (const plugin of plugins) {
                    ...
                    let edits;
                    try {
                        edits = yield plugin.formatOnType(document, position, ch, options);
                    }
                    catch (err) {
                        console.error(err);
                    }
