...
export declare namespace GetDocumentContentRequest {
    ...
    const type: vscode.RequestType<vscode.TextDocumentIdentifier, string, never>;
}
...
export declare namespace ShowReferencesNotification {
    type ResponseType = vscode.TextDocumentPositionParams & {
        references: vscode.Location[];
    };
    const type: vscode.NotificationType<ResponseType>;
}
...
export declare namespace GetEditorSelectionRequest {
    ...
    type ErrorType = never;
    const type: vscode.RequestType0<ResponseType, never>;
}
/**
 * Server Requests
 */
