...
function register(languageService, getTextDocument, settings) {
    return (uri, position, newName) => __awaiter(this, void 0, void 0, function* () {
        ...
        const { providePrefixAndSuffixTextForRename } = (_f = yield ((_e = settings.getPreferences) === null || _e === void 0 ? void 0 : _e.call(settings, document))) !== null && _f !== void 0 ? _f : { providePrefixAndSuffixTextForRename: true };
